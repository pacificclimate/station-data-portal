...
describe("variable2PdpVariableIdentifier", () => {
  it.each([
    ...
    [{ standard_name: "standard_name", cell_method: null }, "standard_name"],
    [{ standard_name: "standard_name", cell_method: "" }, "standard_name"],
    [
    ...
    [
      {
        ...
        cell_method: "time: gronk time: argle",
      },
...
describe("variableSelectorOptions2pdpFormat", () => {
  const allOptions = {
    options: [map(variableOption)([["alpha"], ["beta"], ["gamma"], ["delta"]])],
  };
  ...
  it.each([
    ...
    expect(variableSelectorOptions2pdpFormat(options, allOptions)).toBe(
      expected,
    );
  });
});
