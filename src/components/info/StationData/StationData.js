                ...
                dataCategory => {
                  ...
                  return urlTooLong ? (
                    ...
                    <>
                      ...
                      <span className={"me-2"}>
                      <InfoPopup
                        title={"Download button disabled"}
                      >
                        <p>
                          This button is disabled because the length of the URL
                          for the download ({downloadUrl.length}) exceeds the
                          maximum allowable length for URLs
                          ({config.maxUrlLength}).
                        </p>
                        <p>
                          This is a technical issue, which will be fixed in an
                          upcoming release. In the meantime, you can try the
                          following:
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          many fewer options, they are less likely to be either
