...
const DisabledTrack = ({ error, source, target, getTrackProps, disabled }) => (
  <div
...
DisabledTrack.defaultProps = { disabled: false };

export default DisabledTrack;
